const locale = {
	...
	VIEW_SOURCE_CODE_ON_GITHUB: 'View source code on GitHub',
	WATCH_LATEST_VIDEO_ON_YOUTUBE: 'Watch latest video on YouTube',

	AI_AGENT_PLATFORM: 'AI Agent Platform',
	AI_AGENT_PLATFORM_DESCRIPTION:
		'An open-source platform for building AI agents',
	ALL_RIGHTS_RESERVED: 'All rights reserved',

	EDIT_PROFILE: 'Edit Profile',
	EDIT_PROFILE_DESCRIPTION: 'Edit your profile information',
